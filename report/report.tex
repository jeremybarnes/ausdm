...
It was observed that progress was difficult in the small AUC competition, and that the data had many characteristics of noisy data.  
...
An ensembling algorithm can then use these confidence values to consider only the high-precision (high-confidence) part of any given algorithm's output.  If the selection of algorithms is significantly diverse, it is possible to 
